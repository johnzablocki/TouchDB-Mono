...
{
	public class TDURLConnection : HttpURLConnection
	{
		...
		protected TDURLConnection(Uri url) : base(url)
		{
		...
		internal virtual void SetResponseBody(TDBody responseBody)
		{
			this.responseBody = responseBody;
		}

		public virtual TDBody GetResponseBody()
		{
	...
	internal class Header
	{
		...
		public Header() : base()
		{
			...
			this.keyTable = new SortedDictionary<string, List<string>>(string.CASE_INSENSITIVE_ORDER
				);
		}
